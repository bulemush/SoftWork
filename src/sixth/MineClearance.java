...
public class MineClearance {
    ...
    private static ImageIcon face = new ImageIcon("/Photo/face.jpg");/* 小黄脸图标 */
...
class GamePanel extends JPanel {
    ...
    private Btn[][] btns;
    private byte[][] click;
    private static ImageIcon flag = new ImageIcon("/Photo/flag.jpg");
    private static ImageIcon bomb = new ImageIcon("/Photo/bomb.jpg");
    private static ImageIcon lucency = new ImageIcon("/Photo/lucency.png");
    /* 构造雷区 */
